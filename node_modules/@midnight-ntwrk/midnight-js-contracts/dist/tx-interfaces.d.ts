 ...
 */
export declare const createCallTxOptions: <C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>>(compiledContract: CompiledContract.CompiledContract<C, any>, // eslint-disable-line @typescript-eslint/no-explicit-any
circuitId: PCK, contractAddress: ContractAddress, privateStateId: PrivateStateId | undefined, args: Contract.CircuitParameters<C, PCK>) => CallTxOptions<C, PCK>;
/**
 ...
 */
export declare const createCircuitMaintenanceTxInterface: <C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>>(providers: ContractProviders<C, PCK>, circuitId: PCK, compiledContract: CompiledContract.CompiledContract<C, any>, // eslint-disable-line @typescript-eslint/no-explicit-any
