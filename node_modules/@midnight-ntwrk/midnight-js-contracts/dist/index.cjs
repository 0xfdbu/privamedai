...
recipient.is_left
    ? ledgerV8.ZswapOutput.new(coinInfo, segmentNumber, recipient.left, encryptionPublicKey)
    : ledgerV8.ZswapOutput.newContractOwned(coinInfo, segmentNumber, recipient.right);
