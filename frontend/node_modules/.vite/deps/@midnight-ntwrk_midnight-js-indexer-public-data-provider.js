...
} from "./chunk-ZCF2NJJB.js";
import "./chunk-RLHS7NGE.js";
...
var require_globals = __commonJS({
  "../node_modules/@apollo/client/utilities/globals/globals.cjs"(exports) {
    ...
    var invariant2 = Object.assign(function invariant3(condition, message) {
      ...
      debug: wrap2(tsInvariant.invariant.debug),
      log: wrap2(tsInvariant.invariant.log),
      warn: wrap2(tsInvariant.invariant.warn),
      error: wrap2(tsInvariant.invariant.error)
    });
...
var import_dist4, import_dist5, import_dist6, defaultMakeData, forEach, slice, hasOwnProperty, Trie;
var init_lib = __esm({
  "../node_modules/@wry/trie/lib/index.js"() {
...
var import_dist7, import_dist8, import_dist9, StrongCache;
...
var import_dist10, import_dist11, import_dist12, defaultDispose2, _WeakRef, _WeakMap, _FinalizationRegistry, finalizationBatchSize, WeakCache;
var init_weak = __esm({
  "../node_modules/@wry/caches/lib/weak.js"() {
...
var import_dist16, import_dist17, import_dist18, currentContext, MISSING_VALUE, idCounter, makeSlotClass, globalKey, host, globalHost, Slot;
var init_slot = __esm({
  "../node_modules/@wry/context/lib/slot.js"() {
...
var import_dist19, import_dist20, import_dist21, bind, noContext;
var init_lib3 = __esm({
  "../node_modules/@wry/context/lib/index.js"() {
...
var import_dist22, import_dist23, import_dist24, parentEntrySlot;
...
var import_dist25, import_dist26, import_dist27, hasOwnProperty2, arrayFromSet;
...
var import_dist28, import_dist29, import_dist30, emptySetPool, POOL_TARGET_SIZE, Entry;
...
var import_dist31, import_dist32, import_dist33, EntryMethods;
var init_dep = __esm({
  "../node_modules/optimism/lib/dep.js"() {
...
var import_dist34, import_dist35, import_dist36, defaultKeyTrie, caches;
var init_lib4 = __esm({
  "../node_modules/optimism/lib/index.js"() {
...
var import_dist37, import_dist38, import_dist39, hasSymbols, hasSymbol, getSymbol, SymbolIterator, SymbolObservable, SymbolSpecies, Subscription, SubscriptionObserver, Observable2;
...
var import_dist43, import_dist44, import_dist45, root, result, es_default;
var init_es = __esm({
  "../node_modules/symbol-observable/es/index.js"() {
...
var import_dist46, import_dist47, import_dist48, toString, hasOwnProperty3, fnToStr, previousComparisons, lib_default, nativeCodeSuffix;
var init_lib5 = __esm({
  "../node_modules/@wry/equality/lib/index.js"() {
    import_dist46 = __toESM(require_dist());
    import_dist47 = __toESM(require_dist2());
    import_dist48 = __toESM(require_dist3());
    ({ toString, hasOwnProperty: hasOwnProperty3 } = Object.prototype);
  ...
  "../node_modules/@apollo/client/masking/masking.cjs"(exports) {
    ...
    function maskSelectionSet(data, selectionSet, context, migration, path) {
      ...
      for (var _d = 0, _e = selectionSet.selections; _d < _e.length; _d++) {
        ...
        if (selection.kind === graphql.Kind.INLINE_FRAGMENT && (!selection.typeCondition || context.cache.fragmentMatches(selection, data.__typename))) {
...
var import_dist49, import_dist50, import_dist51, docCache, fragmentSourceMap, printFragmentWarnings, experimentalFragmentVariables, extras, lib_default2;
var init_lib6 = __esm({
  "../node_modules/graphql-tag/lib/index.js"() {
  ...
  "../node_modules/@apollo/client/core/core.cjs"(exports) {
    ...
    var QueryInfo = (function() {
      ...
      QueryInfo2.prototype.setDiff = function(diff) {
        ...
        if (diff && !diff.complete && utilities.muteDeprecations("getLastError", function() {
          var _a3;
        ...
        if (!equal2.equal(oldDiff && oldDiff.result, diff && diff.result)) {
...
var blockToContractState$ = (contractAddress) => (block) => from(block.transactions).pipe(concatMap(({ contractActions }) => from(contractActions)), filter((call) => call.address === contractAddress), map((call) => deserializeContractState(call.state)));
