  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      batchIssue3Credentials: (...args_1) => {
        if (args_1.length !== 11) {
          throw new __compactRuntime.CompactError(`batchIssue3Credentials: expected 11 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const callerPubKey_0 = args_1[1];
        const commitment1_0 = args_1[2];
        const claimHash1_0 = args_1[3];
        const expiry1_0 = args_1[4];
        const commitment2_0 = args_1[5];
        const claimHash2_0 = args_1[6];
        const expiry2_0 = args_1[7];
        const commitment3_0 = args_1[8];
        const claimHash3_0 = args_1[9];
        const expiry3_0 = args_1[10];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
                                                                                                ...
                                                                                                path: [
                                                                                                       { tag: 'value',
                                                                                                         value: { value: _descriptor_13.toValue(1n),
                                                                                                                  alignment: _descriptor_13.alignment() } }] } },
                                                                                       { push: { storage: false,
                                                                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(d_callerPubKey_0),
                                                                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                                                                       'member',
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value),
    ...
    const issuer_0 = _descriptor_8.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               ...
                                                                               [
                                                                                ...
                                                                                { idx: { cached: false,
                                                                                         ...
                                                                                         path: [
                                                                                                { tag: 'value',
                                                                                                  value: { value: _descriptor_0.toValue(d_callerPubKey_0),
                                                                                                           alignment: _descriptor_0.alignment() } }] } },
                                                                                { popeq: { cached: false,
                                                                                           result: undefined } }]).value);
    __compactRuntime.assert(this._is_active_issuer_0(issuer_0),
    ...
    __compactRuntime.assert(!_descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       ...
                                                                                       [
                                                                                        ...
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                            'Credential 1 exists');
    const credential1_0 = { issuer: d_callerPubKey_0,
    ...
    __compactRuntime.assert(!_descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       ...
                                                                                       [
                                                                                        ...
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                            'Credential 2 exists');
    const credential2_0 = { issuer: d_callerPubKey_0,
    ...
    __compactRuntime.assert(!_descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       ...
                                                                                       [
                                                                                        ...
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                            'Credential 3 exists');
    const credential3_0 = { issuer: d_callerPubKey_0,
